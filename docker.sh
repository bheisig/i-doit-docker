...
function buildImages {
    ...
    buildImage 1.18 pro php7.4 apache
    buildImage 1.18 pro php7.4 fpm

    buildImage 1.18 open php7.4 apache
    buildImage 1.18 open php7.4 fpm

    buildImage 1.18.1 pro php7.4 apache
    buildImage 1.18.1 pro php7.4 fpm

    buildImage 1.18.1 open php7.4 apache
    buildImage 1.18.1 open php7.4 fpm

    buildImage 1.18.2 pro php7.4 apache
    buildImage 1.18.2 pro php7.4 fpm

    buildImage 1.18.2 open php7.4 apache
    buildImage 1.18.2 open php7.4 fpm

    buildImage 1.19 pro php7.4 apache
    buildImage 1.19 pro php7.4 fpm
...
function scanImages {
    ...
    scanImage 1.18 pro php7.4 apache
    scanImage 1.18 pro php7.4 fpm

    scanImage 1.18 open php7.4 apache
    scanImage 1.18 open php7.4 fpm

    scanImage 1.18.1 pro php7.4 apache
    scanImage 1.18.1 pro php7.4 fpm

    scanImage 1.18.1 open php7.4 apache
    scanImage 1.18.1 open php7.4 fpm

    scanImage 1.18.2 pro php7.4 apache
    scanImage 1.18.2 pro php7.4 fpm

    scanImage 1.18.2 open php7.4 apache
    scanImage 1.18.2 open php7.4 fpm

    scanImage 1.19 pro php7.4 apache
    scanImage 1.19 pro php7.4 fpm
...
function pushImages {
    ...
    pushImage 1.18.2 pro php7.4 apache
    pushImage 1.18.2 pro php7.4 fpm

    pushImage 1.18.2 open php7.4 apache
    pushImage 1.18.2 open php7.4 fpm

    pushImage 1.19 pro php7.4 apache
    pushImage 1.19 pro php7.4 fpm
...
function printReadme {
    ...
    printSupportedTags 1.19 pro php7.4 fpm
    printSupportedTags 1.19 pro php7.4 apache

    printSupportedTags 1.18.2 open php7.4 fpm
    printSupportedTags 1.18.2 open php7.4 apache

    printSupportedTags 1.18.2 pro php7.4 fpm
    printSupportedTags 1.18.2 pro php7.4 apache

    printSupportedTags 1.18.1 open php7.4 fpm
    printSupportedTags 1.18.1 open php7.4 apache

    printSupportedTags 1.18.1 pro php7.4 fpm
    printSupportedTags 1.18.1 pro php7.4 apache

    printSupportedTags 1.18 open php7.4 fpm
    printSupportedTags 1.18 open php7.4 apache

    printSupportedTags 1.18 pro php7.4 fpm
    printSupportedTags 1.18 pro php7.4 apache
