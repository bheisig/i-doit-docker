...
[![Image size](https://img.shields.io/microbadger/image-size/bheisig/idoit/1.14.2-open-php7.4-fpm.svg)](https://hub.docker.com/r/bheisig/idoit/)
...
~~~ {.bash}
docker run --name i-doit-fpm -p 9000:9000 bheisig/idoit:1.15.1-open-php7.4-fpm
~~~
...
~~~ {.bash}
docker run --name i-doit-apache -p 80:80 bheisig/idoit:1.15.1-open-php7.4-apache
~~~
