...
[![Image size](https://img.shields.io/microbadger/image-size/bheisig/idoit/1.15.2-open-php7.4-fpm.svg)](https://hub.docker.com/r/bheisig/idoit/)
...
-   `1.15.2-open-php7.1-fpm` ([`Dockerfile`](1.15.2/open/php7.1/fpm))
-   `1.15.2-open-php7.1-apache` ([`Dockerfile`](1.15.2/open/php7.1/apache))
...
-   `1.15.2-pro-php7.1-fpm` ([`Dockerfile`](1.15.2/pro/php7.1/fpm))
-   `1.15.2-pro-php7.1-apache` ([`Dockerfile`](1.15.2/pro/php7.1/apache))
...
-   `1.15.1-open-php7.1-fpm` ([`Dockerfile`](1.15.1/open/php7.1/fpm))
-   `1.15.1-open-php7.1-apache` ([`Dockerfile`](1.15.1/open/php7.1/apache))
...
-   `1.15.1-pro-php7.1-fpm` ([`Dockerfile`](1.15.1/pro/php7.1/fpm))
-   `1.15.1-pro-php7.1-apache` ([`Dockerfile`](1.15.1/pro/php7.1/apache))
...
-   `1.15-open-php7.1-fpm` ([`Dockerfile`](1.15/open/php7.1/fpm))
-   `1.15-open-php7.1-apache` ([`Dockerfile`](1.15/open/php7.1/apache))
...
-   `1.14.2-open-php7.3-apache` ([`Dockerfile`](1.14.2/open/php7.3/apache))
-   `1.14.2-open-php7.2-fpm` ([`Dockerfile`](1.14.2/open/php7.2/fpm))
-   `1.14.2-open-php7.2-apache` ([`Dockerfile`](1.14.2/open/php7.2/apache))
-   `1.14.2-open-php7.1-fpm` ([`Dockerfile`](1.14.2/open/php7.1/fpm))
-   `1.14.2-open-php7.1-apache` ([`Dockerfile`](1.14.2/open/php7.1/apache))
...
~~~ {.bash}
docker run --name i-doit-fpm -p 9000:9000 bheisig/idoit:1.15.2-open-php7.4-fpm
~~~
...
~~~ {.bash}
docker run --name i-doit-apache -p 80:80 bheisig/idoit:1.15.2-open-php7.4-apache
~~~
